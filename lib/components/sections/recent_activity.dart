...
import 'package:alubank_curso/components/color_dot.dart';
import 'package:alubank_curso/components/content_division.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text(
            'Esse mês você gastou \$1500.00 com jogos. Tente abaixae esse custo!'),
        TextButton(
          onPressed: () {},
          child: const Text(
            'Diga-me como!',
